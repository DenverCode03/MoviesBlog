...
export default function Traitement() {
    ...
    const handleFilterChange = (filterType, value) => {
        ...
        router.get(route('secretaire.traitement'), newFilters, {
            preserveState: true,
            preserveScroll: true
        });
    };
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('secretaire.traitement'), { ...filters, search: searchTerm }, {
            preserveState: true,
            preserveScroll: true
        });
    };
        ...
        <Base title="Traitement des Requêtes" user={auth.user}>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {[
                        { key: 'en_attente', label: 'En attente', color: 'yellow', value: stats.en_attente },
                        { key: 'en_cours', label: 'En cours', color: 'blue', value: stats.en_cours },
                        { key: 'validees', label: 'Validées', color: 'purple', value: stats.validees },
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Requêtes à traiter</h2>
                            <p className="text-gray-600">Gérez et traitez les demandes des étudiants</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                            ...
                            <select
                                ...
                                className="px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            >
                        ...
                        <div key={requete.id} className={`bg-white border rounded-xl p-6 hover:shadow-md transition-shadow ${
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                                ...
                                <div className="flex-1">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                                                ...
                                                {requete.date_limite && (
                                                    <>
                                                        <span>•</span>
                                                        <span className={isUrgent(requete) ? 'text-red-600 font-medium' : ''}>
                                    ...
                                    {requete.secretaire && (
                                        <div className="text-sm text-gray-600 mb-2">
                                            <span className="font-medium">Traité par:</span> {requete.secretaire.nom}
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    <Link
                                        href={route('secretaire.requetes.show', requete.id)}
                                    ...
                                    {requete.statut === 'en_cours' && requete.secretaire_id === auth.user.id && (
                                        <Link
                                            href={route('secretaire.requetes.show', requete.id)}
                ...
                {requetes.data.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">
                            {searchTerm || filters.statut !== 'en_attente' || filters.priorite !== 'all' || filters.type_requete !== 'all'
