...
export default function Historique() {
    ...
    const handleFilterChange = (filterType, value) => {
        ...
        router.get(route('secretaire.historique'), newFilters, {
            preserveState: true,
            preserveScroll: true
        });
    };
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route('secretaire.historique'), { ...filters, search: searchTerm }, {
            preserveState: true,
            preserveScroll: true
        });
    };
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {[
                        ...
                        { key: 'validees', label: 'Validées', color: 'purple', value: statsPersonnelles.validees },
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Historique de mes traitements</h2>
                                            ...
                                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                                                ...
                                                {requete.date_traitement && (
                                                    <>
                                                        <span>•</span>
                                                        <span>
                                                            Traitée le {new Date(requete.date_traitement).toLocaleDateString('fr-FR')}
                                                        </span>
                                                    </>
                                                )}
                                                <span>•</span>
