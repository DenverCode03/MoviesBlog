...
export default function Base({ children, title = "MyStudentRequest", user }) {
    ...
    const getNavigationItems = () => {
        ...
        if (["secretaire"].includes(user?.role)) {
            return [
                ...baseItems,
                {
                    name: "Requêtes à traiter",
                    href: "/secretaire/traitement",
                    icon: (
                        <svg
                            className="w-5 h-5"
                            fill="none"
        ...
        if (["scolarite", "cellule_infos"].includes(user?.role)) {
            return [
                ...baseItems,
                {
                    name: "Requêtes à traiter",
                    href: "/orgtraitement/traitement",
                    icon: (
                        <svg
                            className="w-5 h-5"
                            fill="none"
                    ...
                    <div className="px-6 py-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                >
                                    <div className="w-20 h-10 rounded-xl overflow-hidden">
                                        <img
                                            src="/image/logo.jpg"
